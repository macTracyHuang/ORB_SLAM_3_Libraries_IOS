...
void LocalMapping::Run()
{
    ...
    while(1)
    {
        ...
        // std::cout << CheckNewKeyFrames() << ',' << mbBadImu << '\n';
        if(CheckNewKeyFrames() && !mbBadImu)
        {
            ...
            // std::cout << "LocalMapping: mlNewKeyFrames size: " << mlNewKeyFrames.size() << '\n';
            ...
            // std::cout << "LocalMapping: mlNewKeyFrameForDenseMap Size: "
            // << mlNewKeyFrameForDenseMap.size() << '\n'; 
