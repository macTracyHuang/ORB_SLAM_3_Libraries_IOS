...
## For iphonesimulator: add -DIOS_DEVICE_ARCHITECTURES="", and -DIOS_DEVICE_ARCHITECTURES=arm64
## For iphoneos: remove -DIOS_DEVICE_ARCHITECTURES="", adn -DIOS_DEVICE_ARCHITECTURES=""
#cmake --build . --config Release
#cd $pwd
##rm -rf VTK
#
